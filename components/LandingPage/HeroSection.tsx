      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className={`space-y-8 ${isRTL ? 'text-right' : 'text-left'}`}>
            <h1 className="text-4xl lg:text-7xl text-white font-bold leading-tight tracking-tight">
            ...
            <div className={`flex flex-wrap gap-4 ${isRTL ? 'justify-end lg:justify-start' : ''}`}>
              ...
              <button className="inline-flex items-center gap-2 px-8 py-4 bg-white/5 hover:bg-white backdrop-blur-sm border border-white/10 text-white rounded-full font-semibold transition-all hover:scale-105">
          ...
          <div className="hidden lg:block relative">
            <div className="relative w-full aspect-square max-w-lg mx-auto">
              ...
              {/* Glass card effect */}
              <div className="absolute inset-4 bg-white backdrop-blur-2xl rounded-[2rem] border border-white/10 shadow-2xl flex items-center justify-center p-8 transform rotate-3 hover:rotate-0 transition-transform duration-500">
                 ...
                 <div className="text-center space-y-4">
                    ...
                    <h3 className="text-2xl font-bold text-gray-600">{t('card.title')}</h3>
