                  ...
                  <table className="w-full">
                    <thead className="bg-gray-50 border-b border-gray-200">
                      <tr>
                        ...
                        <th className={`px-6 py-3 ${isRTL ? 'text-right' : 'text-left'} text-sm font-semibold text-gray-900`}>{t('date')}</th>
              ...
              {modalMode === 'delete' ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-3 pt-4">
                    ...
                    >
                      {createMutation.isPending || updateMutation.isPending ? t('deleting') : (modalMode === 'create' ? tCommon('add') : tCommon('update'))}
                    </button>
                  </div>
                </div>
              )}
