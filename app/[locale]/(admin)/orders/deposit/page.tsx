    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-slate-900 p-6" dir={isRTL ? 'rtl' : 'ltr'}>
            <div className="max-w-7xl mx-auto">
                <div className="mb-8">
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">{t('depositRequests')}</h1>
                    <p className="text-gray-600 dark:text-gray-400 mt-2">{t('depositSubtitle')}</p>
                </div>
