...
export default function SessionsPage() {
  ...
  const statsBadges = [
    { label: t('totalSessions'), value: stats.total_sessions || 0, color: 'border-blue-500', icon: '📊' },
    { label: t('upcoming'), value: stats.upcoming_sessions || 0, color: 'border-purple-500', icon: '📅' },
    { label: t('completed'), value: stats.completed_sessions || 0, color: 'border-green-500', icon: '✓' },
    { label: t('scheduled'), value: stats.scheduled_sessions || 0, color: 'border-yellow-500', icon: '📌' },
  ];
