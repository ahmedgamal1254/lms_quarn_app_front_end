...
export default function ChatPage() {
  ...
  const handleSendFiles = async (files: File[]) => {
    // We send files one by one to avoid large uploads failing all at once, 
    // or we could send them together. Let's send them one by one for better UX/reliability.
