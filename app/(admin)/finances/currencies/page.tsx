...
export default function CurrenciesPage() {
    ...
    const saveMutation = useMutation({
        ...
        onSuccess: () => {
            const msg = modalMode === 'edit' ? 'تم تحديث العملة' : 'تم إضافة العملة بنجاح';
            toast.success(msg);
            ...
            <div className="sticky top-0 z-40 bg-white border-b border-gray-200 shadow-sm">
                <div className="max-w-7xl mx-auto px-6 py-6">
                    <div className="flex flex-col md:flex-row gap-4 justify-between items-start">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900">العملات</h1>
                            <div className="flex items-center gap-2 mt-2 text-gray-600">
                                <Home size={16} />
                                <Link href="/dashboard" className="hover:text-blue-600">الرئيسية</Link>
                                <ChevronRight size={16} />
                                <DollarSign size={16} />
                                <span className="text-sm">العملات</span>
                            </div>
                        </div>
                        <button
            ...
            <div className="max-w-7xl mx-auto px-2 py-4 md:px-6 md:py-8">
                ...
                {isLoading ? (
                    ...
                    <div className="text-center py-16 bg-white rounded-lg border border-gray-200">
                        ...
                        <p className="text-gray-500 text-lg">لا توجد عملات</p>
                    </div>
                ) : (
                    <>
                        {/* Grid View */}
                                ...
                                >
                                    <div className="p-6">
                                        ...
                                        <div className="space-y-2 text-sm">
                                            ...
                                            <div className="flex justify-between">
                                                <span className="text-gray-600">افتراضية:</span>
                                                <span className={`px-2 py-1 rounded text-xs font-medium ${
