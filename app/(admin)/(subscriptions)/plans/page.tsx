...
export default function PlansPage() {
    ...
    const saveMutation = useMutation({
        ...
        onSuccess: () => {
            const msg = modalMode === 'edit' ? 'تم تحديث الخطة' : 'تم إضافة الخطة بنجاح';
            toast.success(msg);
            ...
            <div className="sticky top-0 z-40 bg-white border-b border-gray-200 shadow-sm">
                <div className="max-w-7xl mx-auto px-6 py-6">
                    <div className="flex justify-between items-start">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900">الخطط الدراسية</h1>
                                    ...
                                    >
                                        ...
                                        <div className="space-y-3 pt-4 border-t border-gray-100">
                                            <div className="flex justify-between items-center">
                                                <span className="text-gray-600 text-sm">عدد الحلقات</span>
                                            ...
                                            <div className="flex justify-between items-center">
                                                <span className="text-gray-600 text-sm">السعر لكل حلقة</span>
                                        ...
                                        <p className="text-xs text-gray-500 mt-4 pt-4 border-t border-gray-100">
                                            أنشئت في: {new Date(plan.created_at).toLocaleDateString('ar-EG')}
                                        </p>
                                    </div>
                                );
                            })}
                                ...
                                <table className="w-full text-sm">
                                    <thead>
                                        <tr className="border-b border-gray-200 bg-gray-50">
                                            <th className="px-6 py-3 text-right font-semibold text-gray-900">اسم الخطة</th>
                                            <th className="px-6 py-3 text-right font-semibold text-gray-900">الوصف</th>
                                            <th className="px-6 py-3 text-right font-semibold text-gray-900">عدد الحلقات</th>
                                            <th className="px-6 py-3 text-right font-semibold text-gray-900">السعر</th>
                                            <th className="px-6 py-3 text-right font-semibold text-gray-900">العملة</th>
                                            <th className="px-6 py-3 text-right font-semibold text-gray-900">السعر لكل حلقة</th>
                    ...
                    <div className="bg-white rounded-lg shadow-lg max-w-md w-full">
                        ...
                        <div className="flex justify-between items-center p-6 border-b border-gray-200 bg-blue-50">
                            <h2 className="text-xl font-bold text-gray-900">
                                {modalMode === 'create' ? 'إضافة خطة جديدة' : 'تعديل الخطة'}
                            </h2>
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">عدد الحلقات *</label>
                                <input
                                    type="number"
